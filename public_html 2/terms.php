...
$row_post = $db_query->post(1);
$page_title = "Terms & Conditions| ".PROJECT_TITLE;
...
<div class="layout-2cols" >
  <div class="content grid_12" style="margin-top:50px;">
            ...
            <div class="single-page">
                ...
                <div class="box-single-content">
                    <div class="editor-content">
                       <?php echo stripslashes(html_entity_decode($row_post->description));?>
