...
$page_title = "Manage Account Details";
$table_name = "impact_user";

$table_id=  "user_id";

$add_page = ADMINPATH."/creator_add.php";
$view_page = ADMINPATH."/account_details_view.php";
$edit_page = ADMINPATH."/creator_edit.php";


define("TABLE_ID",$table_id);
$menu_item  = array('Sl No','Name','Email ID', 'Impact Name','Bank Name','Bank Holder Name','Account Number','IFSC Code','UPI Id');
...
$sql_menu = "SELECT * FROM ".$table_name." where user_type='ucreate' order by ".$table_id." desc";
