...
$page_title = "Manage Payment Received";
...
$menu_item  = array('Sl No','Merchant Id','Transaction Id','Date', 'Amount', 'Impact Name','Tier Name', 'For User', 'Status', 'Send Amount','Send Date','Sent Status','Action');
			   ...
			   ?>
                <tr class="<?=$class?>">
                  ...
                  <td><?=$item[transaction_id]?></td>
                   ...
                   <td><?=$row_tier->tier_name?></td>
                   <td><?=$row_user1->impact_name?></td>
