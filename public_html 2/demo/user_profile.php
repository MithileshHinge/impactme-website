...
<?php if($row_user1->c>0) {?>
  ...
  <div class=" col-md-12 project-tab-detail tabbable accordion creater-tabs">
    <ul class="nav nav-tabs clearfix">
      ...
      <a href="<?= $become_impact_link?>" class="become"  <?php if($become_impact==0) {?>onClick="alert('You cannot join your own tiers'); return false;"<?php } ?>>Become ImpactMe</a>
    </ul>
                ...
                <div class="grid_6 marked-category">
                 ...
                 <?php if(strlen($row_user1->about_page) >0) {?>
                  <div class="box-marked-project project-short" style="margin-bottom:20px;">
                    ...
                    <span class="creater-post about" style="padding: 0 18px 0 18px;    text-align: justify;"><?=stripslashes($row_user1->about_page)?></span>
                  </div>
                  <?php } ?>
