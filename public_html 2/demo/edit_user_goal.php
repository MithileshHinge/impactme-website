             ...
             <h2 class="excited">What would you like to work toward with your patrons?</h2>
                ...
                <div class="row-item clearfix" style="position: relative;top: 50px;">
                  <div class="val">
                    ...
                    <br>
                    <p><input type="radio" value="earning" name="goal_type"<?php if($row_user->goal_type=="earning"){?> checked<?php } ?> id="goal_type">&nbsp;Your goals are based on how much you earn on Patreon"</p>
                    ...
                    <br>
                    <p><input type="radio" value="community" name="goal_type"<?php if($row_user->goal_type=="community"){?> checked<?php } ?> id="goal_type">&nbsp; Your goals are based on how many patrons you have on Patreon. </p>
...
<span style="color:#F00; margin-left:120px"><input type="text" readonly id="text_count" value="300" style="width:30px; border:none; background-color:#fff; color:#F00 "> Characters max</span>
                 ...
                 <input type="hidden" name="setGoal" id="setGoal" value="<?=$row_user->goal_type?>">  
                    ...
                    <button class="btn btn-red btn-submit-all newtier" id="goal-submit">Submit</button>
