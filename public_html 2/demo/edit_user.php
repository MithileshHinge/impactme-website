...
<div class="layout-2cols">
  <div class="content grid_12">
              ...
              <div class="form form-profile">
               ...
               <?php if(isset($msg)){?> <div  id="err_msg"><?=$msg?></div> <?php } ?>
                <input type="hidden" name="mode" value="profile" />
                  ...
                  <div class="row-item clearfix">
                    <label class="lbl" for="txt_time_zone" style="    padding-top: 26px;">Which sounds are correct? :</label>
                    <div class="val">
                    <?php
                  ...
                  <div id="imgArea"><img src="<?=$profile_image?>">
                  ...
                  <div class="row-item clearfix">
                   ...
                   <div id="imgAreaCover"><img src="<?=$coverimage?>">
            
                  <div class="progressBar2">
                    <div class="bar2"></div>
                    <div class="percent2">0%</div>
                  </div>
                  <div id="imgChange"><span>Change Cover Photo</span>
                  ...
                  <div class="row-item clearfix">
                    ...
                    <div class="val"  id="user-earning">
                      <label  id="public-earning"> <input  type="radio" value="1" name="earning_visibility" <?=($row_user->earning_visibility==1)?'checked':'checked'?>  >
                    &nbsp;&nbsp; Public (recommended)<br>
                        Anyone who visits your page will see how much you earn per month.</label>
                      <br>
                    <label id="public-earning">  <input  type="radio" value="0" name="earning_visibility" <?=($row_user->earning_visibility==0)?'checked':''?> >
                     &nbsp;&nbsp; Private<br>
                  ...
                  <div class="row-item clearfix">
                    ...
                    <div class="val" id="user-earning">
                     <label id="public-earning"> <input  type="radio" value="1" name="patronage_visibility" <?=($row_user->patronage_visibility==1)?'checked':'checked'?>  >
                      &nbsp;&nbsp;Public (recommended)<br>
                      ...
                      <br>
                     <label id="public-earning"> <input  type="radio" value="0" name="patronage_visibility" <?=($row_user->patronage_visibility==0)?'checked':''?>>
                      &nbsp;&nbsp;Private<br>
	...
	CKEDITOR.replace('about_page',{
                  ...
                  <div class="row-item clearfix">
                    <label class="lbl" for="txt_location" style="padding-top: 43px;">Intro Video:</label>
                  ...
                  <div class="clearfix">
                    <label class="lbl" for="txt_location"  id="user-social">Social Media :</label>
                    
                    <p  id="user-confidence">Give your Impact confidence - securely verify your accounts and display links on your page. We’ll never post on your behalf.</p>
 ...
 $google_button_name = "Connect";
                  ...
                  <div class="row-item clearfix">
                    ...
                    <button class="btn btn-red btn-submit-all newtier"  id="user-save">Save all </button>
                  </div>
