               ...
               <?php if(isset($msg)){?> <div  id="err_msg"><?=$msg?></div> <?php } ?>
                <input type="hidden" name="mode" value="profile" />
                  ...
                  <div class="row-item clearfix">
                    ...
                    <div class="val">
                      <input class="txt" type="text" id="creating_for" value="" onBlur="setWord(this.value)" onKeyUp="setWord(this.value)" name="creating_for" required>
                    </div>
                  </div>
                  <div class="row-item clearfix">
                    ...
                    <div class="val">
                      ...
                      <label style="font-size: 16px;margin: 9px 0 0 20px;"> <input  type="radio" name="tag_line"  id="tagline1" value="" required>
                     <span id="txt1"></span> is creating <span id="wrd1"></span></label>
                      <br>
                       <label style="font-size: 16px;margin: 9px 0 0 20px;"><input  type="radio" name="tag_line" id="tagline2" value="" >
                     <span id="txt2"></span> are creating <span id="wrd2"></span></label>
                    </div>
                  </div>
