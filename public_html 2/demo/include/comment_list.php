...
$sql = $db_query->runQuery("SELECT * FROM tbl_comment where post_id='$post_id' ORDER BY date asc, parent_comment_id asc, comment_id asc");
$search_arr = array();
foreach($sql as $row)
{
