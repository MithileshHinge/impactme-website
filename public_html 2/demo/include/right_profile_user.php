<div class="project-runtime" >
              ...
              <p class="" style="text-align:center;margin: 16px 0 0 0;"><span class="creater-125"><?=$row_user1->full_name?></span></p>
              <p class="creater-count" style="text-align:center; left:0;"><?=$row_user1->tag_line?></p>
