     ...
     <!-- <div class="user-overlay"></div>-->
      <div class="progressBar">
        ...
        <form id="bgimageform" method="post" enctype="multipart/form-data" action="#">
            <div class="uploadFile timelineUploadBG" style="background:url(<?=BASEPATH?>/images/whitecam.png) no-repeat;">
                ...
                <div class="grid_6 marked-category">
                 ...
                 <?php if(strlen($row_user->about_page) >0) {?>
                  <div class="box-marked-project project-short">
                    ...
                    <span class="creater-post about" style="padding: 0 18px 0 18px;    text-align: justify;margin-bottom:20px;"><?=stripslashes($row_user->about_page)?></span>
                  </div>
                  <?php } ?>
                  <div class="box-marked-project project-short" style=""> 
