...
$page_title = "Manage New Submission";
$table_name = "impact_user";

$table_id=  "user_id";
$id = base64_decode($_GET['id']);
$add_page = ADMINPATH."/".$table_name."_add.php";
$view_page = ADMINPATH."/creator_details.php?id=".base64_encode($id);
...
$row_user = $db_query->fetch_object("select * from impact_user where user_id='$id'");
?>
                           ...
                           <div id="home" class="tab-pane active cont">
                              <table class="table no-border no-strip information">
                                 <tbody class="no-border-x no-border-y">
                                       ...
                                       <td>
                                          <table class="table no-border no-strip skills">
                                             <tbody class="no-border-x no-border-y">
                                                ...
                                                <tr>
                                                   <td style="width:20%;"><b>Registration Date</b></td>
                                                   <td><?=$row_user->registration_date?></td>
                                                </tr>
                                                <tr>
                                                   <td style="width:20%;"><b>Registration IP</b></td>
                                                   <td><?=$row_user->register_ip?></td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </td>
                                    ...
                                    <tr>
                                       <td class="category"><strong>Impact Name</strong></td>
                                       <td>
                                          <p><?=$row_user->impact_name?></p>
                                          <p><?=$row_user->tag_line?></p>
                                       </td>
                                    </tr>
                                    <tr>
                                       <td class="category"><strong>Creating For</strong></td>
                                       <td>
                                          <p><?=$row_user->creating_for?></p>
