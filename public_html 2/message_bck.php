...
#searchResultCreator li,#searchResult1 li,#searchResult2 li {
    list-style: none;
...
ul#searchResultCreator,ul#searchResult1,ul#searchResult2 {
    padding: 0px;
}
...
#searchResultCreator li:hover,#searchResult1 li:hover,#searchResult2 li:hover{
 cursor: pointer;
}
#ErrorMsg
{
                   ...
                   <div class="project-tab-detail tabbable accordion edit-about message-display" id="message-box">
                       ...
                       <?php echo $message->load($row_user->email_id); ?>
                                        ...
                                        <div id="impact1" class="modal">
                                          ...
                                          <form class="modal-content animate" action="#" style="width: 44%;">
                                            ...
                                            <div class="container">
                                              <label for="uname"><b style="font-size: 20px;">From <?= $row_impact ?>(Impact)</b></label><br>
                                              

                                              
                                              <input type="text" placeholder="To" name="psw" required class="message-input"><br>
