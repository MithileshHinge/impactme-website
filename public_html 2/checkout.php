...
if(isset($_GET['tid']))
{
	$tier_id = $_GET['tid'];
	if($tier_id >0) {
$row_tier = $db_query->fetch_object("select IFNULL(tier_price,0) price, tier_id, tier_name , description from impact_tier where tier_id = '".$tier_id."'");
	}
	else
	{
...
<section style="background-color: white;">
        ...
        <div class="container">
            ...
            <h3 class="payment-monthly" style="margin-top:60px">Complete your monthly payment to <?= stripslashes($rowUser->impact_name)?></h3>
            ...
            <div class="col-md-12 paymet-box">
                ...
                <div class="col-md-6 choose-pay">
                    ...
                    <div class="col-md-12"><p class="checkout-issue">ImpactMe does not issue refunds on behalf of creators. <a href="#" style="text-decoration: underline;">Learn more.</a></p></div>
