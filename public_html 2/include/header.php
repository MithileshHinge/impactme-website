...
close
	...
	padding-bottom:12px;
      ...
      <?php $sql_notification = $db_query->fetch_object("select count(*) c from impact_notification where user_id='$row_user->user_id' and from_user_id!='$row_user->user_id' and notification_status=0");
      ...
      <div class="hover-notification" id="imp_notification">
          <div class="drop-notification">
              ...
              <?php $sql_notification_d = $db_query->runQuery("select * from impact_notification where user_id='$row_user->user_id' and from_user_id!='$row_user->user_id'  order by notification_id desc limit 10");
			  ...
			  else{$class= "active_notify";}
			
			  ?>
                  <li class="<?=$class?>" id="note<?=$row_notification_d['notification_id']?>" ><a href="#" onclick="javascript:  $.ajax({
      ...
      <!--================its for desktop view==========================-->
        ...
        <div class="hover-pic impact-photores" style="height: 48px; width: 48; bottom">
          ...
          <?php 
             ...
             <li><a href="<?=$url_slug?>" style="background-color:#f2f5fa"> <?=ucwords(strtolower(html_entity_decode($row_user->full_name)))?></a></li>
              ...
              <?php } else { ?>
               ...
               <li><a href="<?=BASEPATH?>/home/" style="background-color:#f2f5fa"> <?=ucwords(strtolower(html_entity_decode($row_user->full_name)))?></a></li>
