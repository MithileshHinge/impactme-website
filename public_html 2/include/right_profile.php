...
<div class="project-runtime" style="margin: 0 0 18px 0;box-shadow: 0 1px 4px rgba(0,0,0,.1);">
             ...
             <div style="text-align:center;">
                  <p class="creater-count" style="text-align:center; left:0;display:inline-block;margin:0 auto;    margin: 11px 14px 0 0;">
                    <span class="creater-125"style="font-size:20px"><?php if (empty($total_impact->c)){
                      ...
                      echo $total_impact->c;
                        ...
                        Supporters</p>
                     <p class="creater-count" style="text-align:center; left:0;display:inline-block;margin:0 auto    ">
