...
$menu_item  = array('Sl No','Type', 'Menu Name' , 'Action');
...
$sql_menu = "SELECT m.menu_id,m.name,m.status, (case when m.menu_type=1 then 'Category' else 'Sub Category' end) category FROM `menu` m ";
$sql_menu.=" order by m.menu_id asc";
