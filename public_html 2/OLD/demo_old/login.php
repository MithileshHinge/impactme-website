...
<div class="col-md-12" style="padding: 0 0 20px 0">
      ...
      <?php if(isset($msg)) {?>  <div class="up" id="msgErr" style="margin-top:0px;"><?php echo $msg;?></div><?php } ?>
        ...
        <div class="form-group">
            ...
            <button class="sign-button " id="login" type="submit">Login in</button>
         
            <p class="with-sign">or Login in with Facebook</p>

            <a href="<?=$loginURL?>" class="sign-facebook" ><span style="margin: 0 10px 0 0"><i class="fa fa-facebook-square"></i></span>Continue with Facebook</a>
