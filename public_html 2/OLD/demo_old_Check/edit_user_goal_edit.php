                ...
                <input type="hidden" name="mode" value="profile" />
                    ...
                    <div class="val">
                      ...
                      <option value="">--Select Goal Type--</option>
                              <option value="earning" <?=($row_edit->goal_type=="earning")?'selected':''?>>Earnings Based Goals</option>
                              <option value="community" <?=($row_edit->goal_type=="community")?'selected':''?>>Community Based Goals</option>
                            </select>
                    </div>
                  </div>
                  
                    <div class="row-item clearfix" id="goal" <?php if($row_edit->goal_type=="community") {?>style="display:none"<?php } ?>>
                    <label class="lbl" for="txt_location">Goal Earning Amount:</label>
                    <div class="val">
                      <input class="txt" type="text" name="goal_price" id="goal_price" value="<?=$row_edit->goal_price?>" onKeyPress="JavaScript: return keyRestrict(event,'0123456789.');" >
                    </div>
                  </div>
                  
                  
                   <div class="row-item clearfix" id="patron" <?php if($row_edit->goal_type=="earning") {?>style="display:none"<?php } ?>>
                    <label class="lbl" for="txt_location">Number Of Patrons:</label>
                    <div class="val">
                      <input class="txt" type="text" name="patron_number" id="patron_number" value="<?=$row_edit->patron_number?>" onKeyPress="JavaScript: return keyRestrict(event,'0123456789.');" >
                    </div>
                  </div>
...
<span style="color:#F00; margin-left:120px"><input type="text" readonly id="text_count" value="300" style="width:30px; border:none; background-color:#fff; color:#F00 "> Characters max</span>
                  ...
                  <input type="hidden" name="mode" value="add">  
                    <button class="btn btn-red btn-submit-all newtier">Update</button>
                  </div>
