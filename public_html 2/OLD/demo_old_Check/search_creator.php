...
$sql = "select count(*) c from impact_user where status= 1 and review_status=1 and user_type='ucreate' and (full_name like '%$s%' or impact_name  like '%$s%')";
$sql1 = "select * from impact_user where status= 1 and review_status=1 and user_type='ucreate' and (full_name like '%$s%' or impact_name  like '%$s%')";
