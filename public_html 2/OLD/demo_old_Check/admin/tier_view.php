...
$page_title = "Manage Tier";
$table_name = "impact_tier";

$table_id=  "tier_id";

$add_page = ADMINPATH."/tier_add.php";
$view_page = ADMINPATH."/tier_view.php";
$edit_page = ADMINPATH."/tier_edit.php";


define("TABLE_ID",$table_id);
$menu_item  = array('Sl No','Email ID', 'Tier Name','Tier Price','Impact Limit', 'Create Date', 'Action');
