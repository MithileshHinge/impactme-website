...
$menu_item  = array('Sl No','Page Name','Post Title',  'Action');
...
<div class="cl-mcont">
			...
			$row_page = $db_query->fetch_object("select page_name from page where page_id=".$item[page_id]);
			  
			   ?>
                <tr class="<?=$class?>">
                  <td><?=$i++?></td>
                  <td><?=$row_page->page_name?></td>
