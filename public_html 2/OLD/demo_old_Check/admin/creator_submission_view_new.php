...
$sql_menu = "SELECT * FROM ".$table_name." where user_type='ucreate' and review_submit_status=1 and review_status=0 order by review_submit_date desc";
...
<div class="cl-mcont">
			  ...
			  if($i%2==0) $class=  "odd "; else $class=  "even ";
			   ...
			   ?>
                ...
                <td><a href="<?=BASEPATH?>/profile/<?=$item['slug']?>/" target="_blank">View</a></td>
