...
class User {
    ...
    private $dbUsername = "impactme";
    private $dbPassword = "+G3,[B&d@X](";
    private $dbName     = "asfewtaW";
    ...
    function checkUser($userData = array()){
        if(!empty($userData)){
            ...
            if($prevResult->num_rows > 0){
                ...
                // Insert user data
                $query = "INSERT INTO ".$this->userTbl." SET  user_id = '".$_SESSION['user_id']."', oauth_provider = '".$userData['oauth_provider']."', oauth_uid = '".$userData['oauth_uid']."', first_name = '".$userData['first_name']."', last_name = '".$userData['last_name']."', email = '".$userData['email']."', gender = '".$userData['gender']."', locale = '".$userData['locale']."', picture = '".$userData['picture']."', link = '".$userData['link']."', created = '".date("Y-m-d H:i:s")."', modified = '".date("Y-m-d H:i:s")."'";
