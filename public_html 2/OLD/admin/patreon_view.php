...
$page_title = "Manage Patreon";
$table_name = "impact_user";

$table_id=  "user_id";

$add_page = ADMINPATH."/patreon_add.php";
$view_page = ADMINPATH."/patreon_view.php";
$edit_page = ADMINPATH."/patreon_edit.php";


define("TABLE_ID",$table_id);
$menu_item  = array('Sl No','Name','Email ID','Password', 'Impact Name','Registration Date', 'Action');
...
$sql_menu = "SELECT * FROM ".$table_name." where user_type='create' order by ".$table_id." desc";
