    ...
    <div class="project-detail">
      <div class="project-tab-detail tabbable accordion edit-about">
        <ul class="tbs clearfix">
          ...
          <li class="activet"><a href="thanks.php" >Thanks</a></li>
        ...
        <div class="tab-content">
          ...
          <div>
            <h3 class="rs alternate-tab accordion-label">Thank</h3>
            <div class="tab-pane accordion-content active">
              <div class="box-list-comment" style="padding:0 0 100px 0">
                <h2 class="excited">How do you want to thank your patrons?</h2>
                <p class="goal">How amazing would it be if your patrons got a personal, secret thank you from you when they pledged? Don't worry, this text isn't required in order to launch. You can come back to this at any time.</p>
               ...
               <p style="color:#F00"><?=base64_decode($_REQUEST['msg'])?></p>
                ...
                <input type="hidden" name="mode" value="update_msg" />
                
                
                 
                  
                  <div class="row-item clearfix">
                    <label class="lbl" for="txt_time_zone">Your Message:</label>
                    <div class="val">
...
<?php
				...
				$ckeditor->editor('info[thanksmsg]',html_entity_decode($dbUser[0]['thanksmsg']));
				?>
                    </div>
                  </div>
