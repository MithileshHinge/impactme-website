<div class="project-runtime" >
              ...
              <p class="" style="text-align:center;margin: 32px 0 0 0;"><span class="creater-125"><?=stripslashes(ucwords(strtolower($row_user1->full_name)))?></span></p>
              <p class="creater-count" style="text-align:center; left:0;"><?=stripslashes(ucfirst(strtolower($row_user1->tag_line)))?></p>
              <p class="creater-count" style="text-align:center; left:0;float: left;margin: 0 0 0 48px;"><span class="creater-125">0</span><br>
                        Impact</p>
