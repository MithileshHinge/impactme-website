<div class="project-runtime" >
              ...
              <p class="creater-name" style="text-align:center; margin-top:32px"><span class="creater-125"><?=stripslashes(ucwords(strtolower($row_user->full_name)))?></span></p>
              <p class="creater-count" style="text-align:center; left:0;"><?=stripslashes(ucfirst(strtolower($row_user->tag_line)))?></p>
              <p class="creater-count" style="text-align:center; left:0;float: left;margin: 0 0 0 48px;" id="impact-count"><span class="creater-125">0</span><br>
                        Impact</p>
                      <p class="creater-count" style="text-align:center; left:0;"><span class="creater-125"><?=CURRENCY?> 0</span><br>
                        Per month</p>
