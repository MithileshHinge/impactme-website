...
file_put_contents($dir, $image);
	 ...
	 (NULL, '".$id_number."', '".$f_name."', '".$l_name."', '".$full_name."',  '".$fbuserData['email']."','".$pwd."', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '".$hash."', '".$hash_active."', '".$status."', '".$user_type."', '".$reg_type."', '".$oauthpro."', '".$oauthid."', '".$file_name."', '".$register_ip."', '".$cover."', '".$full_name."');";
